                                   ...
                                   <div class="table-wrapper">
										<table>
											...
											<tbody>
												...
												<tr>
													<td>对于注册用户，请保持活跃。长期未签到、使用、续期的账户会被系统判定为僵尸用户，我们有权在不通知的情况下限制账户。</td>
												</tr>
												<tr>
													<td>本站免费资源有限，对于注册未使用的用户，将会被系统判断为“僵尸账户”，我们有权在不通知的情况下删除账户。</td>
												</tr>
												<tr>
													<td>对于过期超过30天，未及时续期的用户，我们有权在不通知的情况下删除账户。</td>
												</tr>
                                              <tr>
													<td>对于免费用户、未付费用户，我们有权在不通知的情况下限制、删除账户。</td>
												</tr>
												<tr>
													<td>对于滥用邀请，邀请“僵尸账号”超过1/3的用户，我们有权力收回所有邀请返利。</td>
												</tr>
												<tr>
													<td>对于过期超过X个月，且余额低于X元的用户，我们有权利在不通知的情况下删除账号。*X为正整数。</td>
												</tr>
												<tr>
