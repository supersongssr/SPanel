...
<head>
	...
	<link href="/jscdn/npm/material-design-lite@1.1.0/dist/material.min.css" rel="stylesheet">
    <link href="/jscdn/gh/DataTables/DataTables@1.10.19/media/css/dataTables.material.min.css" rel="stylesheet">
				...
				<ul class="nav">
					<li>
						...
						<ul class="menu-collapse collapse in" id="ui_menu_node">
							...
							<li><a href="/admin/nodectl?class=0&group=0"><i class="icon icon-lg">router</i>&nbsp;节点调整</a></li>
