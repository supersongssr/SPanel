        ...
        <transition name="loading-fade" mode="out-in">
            ...
            <div v-cloak v-else-if="isLoading === 'loaded'" class="flex wrap" key="loaded">
                ...
                <div class="footer pure-g">
                    <div class="pure-u-1 pure-u-sm-1-2 staff">POWERED BY <a href="./staff">SSP-UIM</a></div>
...
const Root = {
    ...
    <div class="title pure-g">
        <div class="pure-u-1 pure-u-xl-1-2 title-left">
            ...
            <span>邀请好友送5￥/人，64G流量/次；被邀请人送3￥；<br>永久免费1-3M带宽；签到送1-5G流量/天</span>
            ...
            <a class="button-index" href="/indexold">旧版首页</a>
...
const Reset = {
    ...
    <div class="page-pw pure-u-1">
        <h1>密码重置页demo</h1>
        <a href="./password/reset">点此进入旧版密码重置页面</a>
    </div>
    `,
}
